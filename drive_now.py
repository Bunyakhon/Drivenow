        ...
        while keep_going:   # วนลูปเพื่อให้โปรแกรมแสดงเมนูซ้ำจนกว่าจะถูกสั่งให้หยุด
            ...
            try:
                ...
                if number_menu == 1:    # ถ้าผู้ใช้เลือกเมนูหมายเลข 1 (ค้นหาข้อมูล)
                    fdn.search_data(number_menu)   # เรียกใช้ฟังก์ชัน search_data จากโมดูล func_drive_now
                    ...
                    fdn.edit_data_customer(number_menu)   # เรียกใช้ฟังก์ชัน edit_data_customer จากโมดูล func_drive_now เพื่อแก้ไขข้อมูล
                    time.sleep(1)    # หน่วงเวลาการทำงาน 1 วินาที

                elif number_menu == 4:   # ถ้าผู้ใช้เลือกเมนูหมายเลข 4 (ลบข้อมูลการเช่ารถ)
                    fdn.delet_data(number_menu)   # เรียกใช้ฟังก์ชัน delet_data จากโมดูล func_drive_now เพื่อลบข้อมูล
                    time.sleep(1)    # หน่วงเวลาการทำงาน 1 วินาที

                elif number_menu == 5:   # ถ้าผู้ใช้เลือกเมนูหมายเลข 5 (รายงานข้อมูลการเช่า)
                    print(re.report_data(number_menu))   # เรียกใช้ฟังก์ชัน report_data จากโมดูล gen_report เพื่อแสดงรายงานข้อมูลการเช่า
                    time.sleep(1)    # หน่วงเวลาการทำงาน 1 วินาที
